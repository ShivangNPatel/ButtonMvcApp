...
namespace ButtonMvcApp.Controllers
{
    public class ButtonsController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ButtonsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Material,Size,ManufactringDate,Color,Price")] Button button)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Material,Size,ManufactringDate,Color,Price")] Button button)
        {
            if (id != button.Id)
            {
                return NotFound();
